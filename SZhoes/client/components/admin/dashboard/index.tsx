 ...
 */
export function AdminDashboardComp() {
    ...
    return (
        <div id="content-to-pdf" className="space-y-5">
            <WelcomeUser name="Ansh Yadav" post="CEO" />
            <DataCardMap title="Overall Balance Sheet" dataList={balanceSheet} />
            <Chart title="Balance statistics" imagePath={imagePath} />
            <DetailTabs tabs={detailTabsData} />
        </div>
    );
}