...
export function Trending() {
    return (
        <div className="w-11/12 mx-auto rounded-sm shadow-lg shadow-neutral-300 bg-white">
            <div className={`${montserrat_Subrayada.className} text-2xl ml-10 [word-spacing:15px] pt-2`}>Trending</div>
            <Link prefetch={false} href={"#"} className="flex flex-col items-center">
                <Image src="/images/hero_section.png" alt="Trending Image" className="object-fill w-1/3" width={0} height={0} unoptimized />
                ...
                <Button href="product" className="bg-green-500 mb-5" radius="none">SHOP NOW</Button>
            </Link>
        </div>
    )
}