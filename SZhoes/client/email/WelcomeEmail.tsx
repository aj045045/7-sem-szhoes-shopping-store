...
import { Html, Head, Body, Tailwind, Text, Section, Img, Preview, Container, Heading, Hr, Link, Button, CodeInline, Markdown } from "@react-email/components";
...
WelcomeEmailComp.PreviewProps = {
    ...
    createdAt: FormatDate("2024-09-27T05:48:15.015Z"),
}
