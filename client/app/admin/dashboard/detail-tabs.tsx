 ...
 */
export function DetailTabsPage({ tabs }: { tabs: DetailTabsInterface[] }) {
    return (
        <Tabs aria-label="Options" classNames={{ panel: "hidden sm:block rounded-md mt-0 p-0 mr-2", cursor: "bg-green-500 text-green-900", tabList: "hidden sm:flex bg-transparent px-3 py-2 mt-10" }} items={tabs}>
