...
// import { FaCheck, FaIndustry, FaMoneyBillTrendUp, FaPersonShelter, } from "react-icons/fa6";
                    ...
                    {isDisplay ? (
                        <>
                            <div className="flex items-end bg-green-100 rounded-full p-2 border-2 border-green-300">
                                <div className={`${montserratSubrayada.className} text-2xl`}>S</div>
                                <div className={`${comforterBrush.className} text-green-600 text-2xl`}>Z</div>
                            </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-3 flex items-center space-x-2">
                    {!isDisplay ? (
                        <Tooltip placement="left-end" showArrow offset={20} radius="sm" content={
                            ...
                            <div className="text-2xl rounded-full bg-gradient-to-tl from-lime-400 to-orange-400 py-1 px-3">{name[0]}</div>
                        </Tooltip>
                    ) : (
                        <>
                            <div className="text-2xl rounded-full bg-gradient-to-tl from-lime-400 to-orange-400 py-1 px-3">{name[0]}</div>
